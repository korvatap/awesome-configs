...
tyrannical.tags = {
    {
        ...
        init        = true                                           ,
        exclusive   = true                                           ,
        icon        = "/home/tapio/.config/awesome/icons/term.png"   ,
...
--         mwfact      = 0.6,
    ...
    } ,
    {
        ...
        init        = true                                           ,
        exclusive   = true                                           ,
        icon        = "/home/tapio/.config/awesome/icons/net.png",
    ...
    } ,
    {
        ...
        init        = true                                           ,
        exclusive   = true                                           ,
        icon        = "/home/tapio/.config/awesome/icons/folder.png",
        screen      = config.scr.pri                          ,
        layout      = awful.layout.suit.magnifier                         ,
        exec_once   = {"dolphin"},
    ...
    } ,
    {
     ...
     init        = true                                              ,
        exclusive   = true                                           ,
--                     screen      = {config.scr.pri, config.scr.sec}     ,
        icon        = "/home/tapio/.config/awesome/icons/bug.png",
    ...
    } ,
    {
        ...
        exclusive   = false                                           ,
--                     screen      = {config.scr.pri, config.scr.sec}     ,
        icon        = "/home/tapio/.config/awesome/icons/editor.png"   ,
    ...
    } ,
    {
        ...
        init        = true                                           ,
        exclusive   = true                                           ,
        icon        = "/home/tapio/.config/awesome/icons/media.png",
        layout      = awful.layout.suit.max                          ,
        class = { 
...
--                     screen      = config.scr.music                          ,
        icon        = "/home/tapio/.config/awesome/icons/info.png" ,
        layout      = awful.layout.suit.max                          ,
        force_screen= true                                           ,
        class       = {
    ...
    -----------------VOLATILE TAGS-----------------------
    {
        ...
        position    = 10                                             ,
        exclusive   = true                                           ,
        icon        = "/home/tapio/.config/awesome/icons/image.png" ,
        layout      = awful.layout.suit.max                          ,
    ...
    } ,
    {
        ...
        position    = 10                                             ,
        exclusive   = true                                           ,
        icon        = "/home/tapio/.config/awesome/icons/video.png" ,
        layout      = awful.layout.suit.max                          ,
    ...
    } ,
    {
        ...
        position    = 10                                             ,
        exclusive   = true                                           ,
        icon        = "/home/tapio/.config/awesome/icons/3d.png" ,
    ...
    } ,
    {
        ...
        position    = 10                                             ,
        exclusive   = true                                           ,
        icon        = "/home/tapio/.config/awesome/icons/download.png" ,
        layout      = awful.layout.suit.max                          ,
    ...
    } ,
    {
        ...
        position    = 10                                             ,
        exclusive   = true                                           ,
        icon        = "/home/tapio/.config/awesome/icons/office.png" ,
        layout      = awful.layout.suit.max                          ,
        class       = {
    ...
    } ,
    {
        ...
        position    = 10                                             ,
        exclusive   = true                                           ,
        icon        = "/home/tapio/.config/awesome/icons/rss.png" ,
        layout      = awful.layout.suit.max                          ,
        class       = {}
    } ,
    {
        ...
        icon        = "/home/tapio/.config/awesome/icons/chat.png" ,
        layout      = awful.layout.suit.tile                         ,
        class       = {"Pidgin"        , "Kopete"         ,}
    } ,
    {
        ...
        position    = 10                                             ,
        exclusive   = true                                           ,
        icon        = "/home/tapio/.config/awesome/icons/burn.png" ,
        layout      = awful.layout.suit.tile                         ,
        class       = {"k3b"}
    } ,
    {
...
--         screen      = config.scr.sec or config.scr.pri     ,
        icon        = "/home/tapio/.config/awesome/icons/mail2.png" ,
        layout      = awful.layout.suit.max                          ,
    ...
    } ,
    {
        ...
        init        = true                                           ,
        spawn       = "konversation"                                 ,
        icon        = "/home/tapio/.config/awesome/icons/irc.png" ,
        force_screen= true                                           ,
    ...
    } ,
    {
        ...
        leave_kills = true                                           ,
        persist     = true                                           ,
        icon        = "/home/tapio/.config/awesome/icons/tools.png" ,
        layout      = awful.layout.suit.max                          ,
        class       = {}
    } ,
    {
    ...
    } ,
    {
        ...
        position    = 10                                             ,
        exclusive   = false                                          ,
        icon        = "/home/tapio/.config/awesome/icons/game.png" ,
        force_screen= true                                           ,
        layout      = awful.layout.suit.max                        ,
